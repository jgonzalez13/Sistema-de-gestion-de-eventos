          ...
          <div>
              ...
              <div className="pure-menu pure-menu-horizontal pure-menu-scrollable custom-menu custom-menu-bottom custom-menu-tucked" id="tuckedMenu">
                ...
                <ul className="pure-menu-list">
                  <li className="pure-menu-item">
                    <Link to="/" className="pure-menu-link" onClick={this.handleOnClick}>Inicio</Link>
                  </li>
                  <li className="pure-menu-item">
                  ...
                  </li>
                  {
                    (this.state.authed)
                      ?
                        <span>
                          <li className="pure-menu-item">
                            <Link to="/reportes" className="pure-menu-link" onClick={this.handleOnClick}>Reportes</Link>
                          </li>
                          <li className="pure-menu-item">
                            <Link 
                              to="/logout"
                      ...
                      :
                        <span>
                          ...
                          <li className="pure-menu-item">
                              <Link to="/login" className="pure-menu-link" onClick={this.handleOnClick}>Iniciar Sesión</Link>
                          </li>
                        </span>
                  }
                </ul>
            ...
            <main className="Main">
              <Switch>
                ...
                <PrivateRoute authed={this.state.authed} path='/reportes' component={DashboardCourses} />
